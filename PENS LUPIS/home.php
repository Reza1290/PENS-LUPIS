        ...
        <div class="content">
            <div class="content-child">
                <div class="parent-card">
                    <div class="child-card" style="width: 100%;">
                        <div class="card-content" >
                            <div class="card-header">
                                Aplikasi dan Layanan
                            </div>
                            <div class="card-body">
                                <?php if($_SESSION['a_global']->role == 0){?>
                                <a href="index.php" class="card-menu">
                                    ...
                                    <div class="caption">
                                        Data Mahasiswa
                                        <p>Data Mahasiswa Pens</p>
                                    </div>    
                                    </div>    
                                </a>
                                    <a href="" class="card-menu">
                                    <div class="card-menu-content">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M96 80c0-26.5 21.5-48 48-48H432c26.5 0 48 21.5 48 48V384H96V80zm313 47c-9.4-9.4-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L409 161c9.4-9.4 9.4-24.6 0-33.9zM0 336c0-26.5 21.5-48 48-48H64V416H512V288h16c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V336z"/></svg>
                                        <div class="caption">
                                            Presensi
                                        <p>Absensi mata kuliah</p>
                                        </div>
                                    </div>
                                    </a>
                                    <a href="tugas.php" class="card-menu">
                                    <div class="card-menu-content">
                                    ...
                                    <a href="" class="card-menu">
                                    <div class="card-menu-content">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M8 256a56 56 0 1 1 112 0A56 56 0 1 1 8 256zm160 0a56 56 0 1 1 112 0 56 56 0 1 1 -112 0zm216-56a56 56 0 1 1 0 112 56 56 0 1 1 0-112z"/></svg>
                                        <div class="caption">
                                            Other
                                            <p>Tugas dari mata kuliah</p>
                                        </div>
                                ...
                                <?php }else if($_SESSION['a_global']->role == 1){?>
                                <a href="index.php" class="card-menu">
                                    <div class="card-menu-content">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM609.3 512H471.4c5.4-9.4 8.6-20.3 8.6-32v-8c0-60.7-27.1-115.2-69.8-151.8c2.4-.1 4.7-.2 7.1-.2h61.4C567.8 320 640 392.2 640 481.3c0 17-13.8 30.7-30.7 30.7zM432 256c-31 0-59-12.6-79.3-32.9C372.4 196.5 384 163.6 384 128c0-26.8-6.6-52.1-18.3-74.3C384.3 40.1 407.2 32 432 32c61.9 0 112 50.1 112 112s-50.1 112-112 112z"/></svg>
                                    <div class="caption">
                                ...
                                <div class="card-profile">
                                    <div class="card-menu-content">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p><?php echo $_SESSION['a_global']->NIP?></p>
                                            <br>
                                            <a href="" class="set-acc"> Kelola Akun  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg></a>
                                        </div>
                                    </div>
                                </div>
                            </div> 

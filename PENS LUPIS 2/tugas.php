                ...
                <div class="parent-card">
                    <div class="child-card" style="width: 70%;">
                        <div class="card-content" >
                            ...
                            <div class="card-body">
                                <?php if($_SESSION['a_global']->role_id == 1){
                                    $id = $_SESSION['a_global']->user_id;

                                    $c = mysqli_query($conn,"SELECT * FROM `tb_enroll_class` ec
                                    JOIN `tb_matkul` m ON ec.matkul_id=m.matkul_id
                                    JOIN `tb_class` c ON ec.class_id=c.class_id
                                    WHERE mahasiswa_id='$id'
                                    GROUP BY m.matkul_name
                                    ");
                                    //$matkul = mysqli_fetch_object($c);
                                    
                                    
                                    while($row = mysqli_fetch_array($c)){
                                        
                                        ?>
                                    <a href="submit.php?id=<?php echo $row['matkul_id'];?>" class="card-menu">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M96 0C43 0 0 43 0 96V416c0 53 43 96 96 96H384h32c17.7 0 32-14.3 32-32s-14.3-32-32-32V384c17.7 0 32-14.3 32-32V32c0-17.7-14.3-32-32-32H384 96zm0 384H352v64H96c-17.7 0-32-14.3-32-32s14.3-32 32-32zm32-240c0-8.8 7.2-16 16-16H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16zm16 48H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
                                        <div class="caption">
                                            <?php echo $row['matkul_name'];?> 
                                            <p><?=$row['class_name']?></p>
                                        </div>    
                                    </div>    
                                    </a>
                                    
                                <?php }}else if($_SESSION['a_global']->role_id == 2){
                                    $dosen_id = $_SESSION['a_global']->user_id;

                                    
                                    $subject_query = mysqli_query($conn,"SELECT * FROM `tb_matkul` m
                                    JOIN `tb_enroll` e ON e.matkul_id = m.matkul_id 
                                    JOIN `tb_class` c ON c.class_id = e.class_id
                                    WHERE e.dosen_id='$dosen_id'");
                                    //$subject = mysqli_fetch_object($subject_query);
                                    
                                    
                                    while($arr = mysqli_fetch_array($subject_query)){
                                    ?>
                                    <a href="assign.php?id=<?php echo $arr['class_id'];?>&id_matkul=<?php echo $arr['matkul_id'];?>" class="card-menu">
                                    <div class="card-menu-content">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M96 0C43 0 0 43 0 96V416c0 53 43 96 96 96H384h32c17.7 0 32-14.3 32-32s-14.3-32-32-32V384c17.7 0 32-14.3 32-32V32c0-17.7-14.3-32-32-32H384 96zm0 384H352v64H96c-17.7 0-32-14.3-32-32s14.3-32 32-32zm32-240c0-8.8 7.2-16 16-16H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16zm16 48H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
                                        <div class="caption">
                                            <?php echo $arr['matkul_name'];?> 
                                            <p><?= $arr['class_name']?></p>
                                        </div>    
                                    </div>    
                                    </a>
                                ...
                                <?php }} if($_SESSION['a_global']->role_id == 99){
                                    $matkul = mysqli_query($conn,"SELECT * FROM `tb_matkul` WHERE 1");
                                    ...
                                    <a href="enroll-dosen.php?id=<?php echo $row['matkul_id'];?>" class="card-menu">
                                    <div class="card-menu-content">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M96 0C43 0 0 43 0 96V416c0 53 43 96 96 96H384h32c17.7 0 32-14.3 32-32s-14.3-32-32-32V384c17.7 0 32-14.3 32-32V32c0-17.7-14.3-32-32-32H384 96zm0 384H352v64H96c-17.7 0-32-14.3-32-32s14.3-32 32-32zm32-240c0-8.8 7.2-16 16-16H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16zm16 48H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
                                        <div class="caption">
                                            <?php echo $row['matkul_name'];?> 
                                            <p><?='Enroll Dosen untuk Mata Kuliah '.$row['matkul_name']?></p>
                                        </div>    
                                    </div>    
                                    </a>
                                    <?php }}?>
                            ...
                            <div class="card-footer">
                                ...
                                if($_SESSION['a_global']->role_id == 99){?>

                                        <?php include 'tambah-matkul.php' ?>
                                        <button class="openButton" onclick="openForm()"><strong>Tambah Matkul</strong></button>
                                    
                               
                                <?php }
                                if($_SESSION['a_global']->role_id == 1){
                                    include 'db.php';
                                    $m = mysqli_query($conn,"SELECT * FROM `tb_matkul` WHERE 1");
                                    $k = mysqli_query($conn,"SELECT * FROM `tb_class` WHERE 1");
                                    
                                ?>   
                            
                                        <?php include 'claim-matkul.php' ?>
                                        <button class="openButton" onclick="openForm()"><strong>Claim Matkul</strong></button>
                                <?php }?>

...
function registrasi($data) {
    ...
    //insert ek database
    include 'db.php';
    mysqli_query($conn, "INSERT INTO tb_user(`user_id`,`username`,`password`,`nama`,`role_id`) VALUES(null,'".$username."','".$password."','".$nama."',1)");
...
<div class="box-pos">
            <div class="box-login">
                ...
                <form action="" method="POST">
                    <input type="text" name="nama" placeholder="Nama Lengkap" class="input-box">
